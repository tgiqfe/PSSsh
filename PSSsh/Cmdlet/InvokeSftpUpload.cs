...
{
    /// <summary>
    /// 対象のSSHサーバにSFTPを使用してファイルをアップロード
    /// </summary>
    [Cmdlet(VerbsLifecycle.Invoke, "SftpUpload")]
    public class InvokeSftpUpload : PSCmdlet
    {
        ...
        protected override void BeginProcessing()
        {
            ...
            debugMode = true;
#endif
            Item.Logger = Function.SetLogger(Item.LOG_DIRECTORY, "InvokeSftpUpload", debugMode);
            Item.Logger.Info(Function.GetPropertyString<InvokeSftpUpload>(this));
        }
