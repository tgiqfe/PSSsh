...
{
    /// <summary>
    /// 対象のSSHサーバからSCPを使用してファイルをダウンロード
    /// </summary>
    [Cmdlet(VerbsLifecycle.Invoke, "ScpDownload")]
    public class InvokeScpDownload : PSCmdlet
    {
        ...
        protected override void BeginProcessing()
        {
            ...
            debugMode = true;
#endif
            Item.Logger = Function.SetLogger(Item.LOG_DIRECTORY, "InvokeScpDownload", debugMode);
            Item.Logger.Info(Function.GetPropertyString<InvokeScpDownload>(this));
        }
